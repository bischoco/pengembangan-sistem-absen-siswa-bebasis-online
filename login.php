...
<body>   
    ...
    <div class="container">
        ...
        <?php } ?>
            <form action="check-auth/check-login.php" method="post">
                <div class="form_group">
                <label class="sub_title" for="nama">Nama</label>
                <input placeholder="Masukan nama kamu" name="nama" class="form_style" type="text">
            </div>
            <div class="form_group">
            ...
            <div class="form_group" id="input-kelas" >
               ...
               <select name="kelas"  class="form_style">
            ...
            <div>
                ...
                <p>Tidak memiliki akun? <a class="link" href="daftar.php">Buat akun!</a></p>
            </div>
    </form>
    </div>
    </div>
